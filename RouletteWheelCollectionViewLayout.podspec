Pod::Spec.new do |s|
  ...
  s.source_files = 'RouletteViewDemo/RVCollectionViewLayout.{h,m}','RouletteViewDemo/RVCollectionViewCell.{h,m}'
  s.requires_arc = true
  s.frameworks   = 'CoreGraphics'
  s.resources    = 'RouletteViewDemo/Images/*.{png}','RouletteViewDemo/**/*.{xib}'
